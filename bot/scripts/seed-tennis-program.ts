...
const DESCRIPTION =
  ...
  "ротация плеч/бедер - ВИИТ/кондиция - навыки (приземление/плиометрика). " +
  "Фазы: база - гипертрофия - сила - мощь+ВИИТ - разгрузка. Игра на корте - вне шаблона.";
const EQUIPMENT = "Оборудование тренажерного зала";
...
const NEW_EXERCISES: NewExercise[] = [
  ...
  },
  {
    ...
    descriptionRu: "Подъем на носки для икроножных и камбаловидной.",
  ...
  },
  {
    ...
    techniqueRu: "Медленное (3-4 сек) опускание стопы внутрь под контролем - без веса в начале. Только при отсутствии боли.",
  ...
  {
    name: "Наружная ротация плеча (кабель, стоя)",
    aliases: ["external rotation cable", "ER плеча", "Отведение плеча наружу (кабель лёжа)", "Отведение плеча наружу кабель лежа"],
    descriptionRu: "Изолированная наружная ротация плеча стоя для манжеты.",
    techniqueRu: "Стоя боком к тросу, локоть у корпуса согнут 90 градусов, медленная наружная ротация предплечья наружу. Без включения трапеции.",
  ...
  },
  {
    ...
    techniqueRu: "Стоя боком к тросу, жим от груди вперед с удержанием таза/плеч без поворота. Медленно.",
  ...
  },
  {
    ...
    techniqueRu: "Поворот корпуса с броском медбола в стену/партнеру. Взрывно, но без переразгибания поясницы. Только после разминки.",
