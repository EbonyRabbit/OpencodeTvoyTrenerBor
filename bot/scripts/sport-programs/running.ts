...
function buildDayB(w: number, phase: Phase): ParsedExercise[] {
  ...
  ex.push(strength(phase, "Жим", "Отжимания на брусьях", "грудные/трицепс - опускание до 90 градусов в локте, корпус без раскачки; при боли в плече/грудине - заменить на отжимания"));
